                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-blog-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea  class="nic-edit" name="sub_title"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="video_link" placeholder="{{ __('video_link') }}" required=""  value="{{ Request::old('video_link') }}">
                          </div>
                        </div>
