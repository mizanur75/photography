...
class ServiceController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->editColumn('sub_title', function(Service $data) {
                                $sub_title = strlen(strip_tags($data->sub_title)) > 250 ? substr(strip_tags($data->sub_title),0,250).'...' : strip_tags($data->sub_title);
                                return  $sub_title;
                            })
